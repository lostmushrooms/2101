...
sql.query = {
	...
	ct_accepted_bids: 'SELECT Bids.oname as oname, Bids.ostart_ts as start, Bids.oend_ts as end, Bids.bidded_price_per_hour as price FROM Availabilities inner join Bids on Availabilities.id = Bids.availabilityId WHERE Availabilities.ctname = $1 and Bids.id in (SELECT id FROM AcceptedBids)',
